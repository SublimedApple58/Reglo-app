...
const MotionHighlight = React.forwardRef(function MotionHighlightInner<
  T extends string,
...
const MotionHighlightItem = React.forwardRef(function MotionHighlightItem(
  {
    children,
    id,
    value,
...
}) as (props: MotionHighlightItemProps & { ref?: React.Ref<HTMLDivElement> }) => React.ReactElement;
