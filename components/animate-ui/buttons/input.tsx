    ...
    >
      <div
        ...
        className={cn(
          ...
          (showInput || localShowInput) && "w-full max-w-[200px]",
          className,
        )}
        {...props}
      />
        ...
        <div className="absolute inset-0 size-full flex items-center justify-center">
          ...
          >
            <input
              ...
              className={cn(
                "size-full selection:bg-primary selection:text-primary-foreground placeholder:text-muted-foreground inset-0 pl-4 focus-visible:border-ring border focus-visible:ring-ring/50 focus-visible:ring-[3px] pr-16 py-2 text-sm bg-background rounded-full focus:outline-none absolute shrink-0 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive disabled:pointer-events-none disabled:cursor-not-allowed",
                className,
              )}
              {...props}
            />
