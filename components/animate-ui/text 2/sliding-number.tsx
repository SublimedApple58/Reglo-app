...
type SlidingNumberProps = Omit<React.ComponentProps<"span">, "ref"> & {
...
const SlidingNumber = React.forwardRef(function SlidingNumberInner(
  {
    number,
    className,
    inView = false,
...
}) as (props: SlidingNumberProps & { ref?: React.Ref<HTMLSpanElement> }) => React.ReactElement;
