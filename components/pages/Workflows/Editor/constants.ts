...
export const primaryNodeStyle = {
  ...
  color: "#111111",
  fontWeight: 600,
  boxShadow: "0 18px 30px -24px rgba(0, 0, 0, 0.12)",
};
...
export const startNodeStyle = {
  ...
  color: "#f8fafc",
  fontWeight: 700,
  boxShadow: "0 22px 38px -26px rgba(236, 72, 153, 0.4)",
};
...
> = {
  ...
  "doc-manager": {
    ...
    blocks: [
      ...
      { id: "doc-upload", label: "Carica documento", status: "planned", hint: "In arrivo" },
      { id: "doc-validate", label: "Valida documento", status: "planned", hint: "In arrivo" },
      {
        id: "doc-route",
        label: "Instrada per approvazione",
        status: "planned",
        hint: "In arrivo",
      },
      { id: "doc-archive", label: "Archivia in repository", status: "planned", hint: "In arrivo" },
      {
        id: "doc-tag",
        label: "Applica tag e classificazione",
        status: "planned",
        hint: "In arrivo",
      },
    ],
  ...
  "reglo-actions": {
    ...
    group: "docs",
    blocks: [
      { id: "reglo-sync", label: "Sincronizza metadati", status: "planned", hint: "In arrivo" },
      {
        id: "reglo-route",
        label: "Instrada al reparto corretto",
        status: "planned",
        hint: "In arrivo",
      },
      { id: "reglo-validate", label: "Valida policy interne", status: "planned", hint: "In arrivo" },
      { id: "reglo-notify", label: "Notifica stakeholder", status: "planned", hint: "In arrivo" },
      { id: "reglo-log", label: "Logga evento in audit trail", status: "planned", hint: "In arrivo" },
  ...
  "doc-compile-template": {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        hint: "Puoi usare Inserisci dato per rendere il nome dinamico.",
      },
    ],
  },
  "reglo-email": {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        hint: "Usa Inserisci dato per rendere dinamico il destinatario.",
      },
      {
        key: "subject",
        label: "Oggetto",
        placeholder: "Es. Conferma compilazione per Mario Rossi",
        required: true,
        hint: "Usa Inserisci dato per personalizzare l'oggetto.",
      },
      {
        key: "body",
        label: "Corpo",
        placeholder: "Scrivi il testo della mail (puoi usare dati dinamici).",
        required: true,
        hint: "Usa Inserisci dato per rendere il testo dinamico.",
        multiline: true,
      },
    ],
  },
