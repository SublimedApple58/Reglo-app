...
export function LogicIfNode({ data, selected }: NodeProps<LogicNodeData>) {
  return (
    <div
      className={cn(
        "relative min-w-[220px] rounded-2xl border bg-[#e9f2f2] px-4 py-3 text-foreground shadow-md",
    ...
    >
      ...
      <Handle
        ...
        id="in"
        className="h-2.5 w-2.5 -translate-x-1/2 border-2 border-white bg-foreground"
        style={{ left: "50%" }}
      />
      <Handle
        type="source"
