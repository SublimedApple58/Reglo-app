  ...
  return (
    <div className="relative flex min-h-[calc(100vh-160px)] w-full gap-6 p-6">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-20 right-8 h-60 w-60 rounded-full bg-[#EC4899]/10 blur-3xl" />
        <div className="absolute bottom-10 left-10 h-48 w-48 rounded-full bg-[#EC4899]/10 blur-3xl" />
      </div>
      <DocEditorSidebar
        tools={toolItems}
