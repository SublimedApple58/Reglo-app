  ...
  "reglo-focus-ring inline-flex items-center justify-center rounded-full border px-2.5 py-1 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-transparent bg-secondary/80 text-secondary-foreground [a&]:hover:bg-secondary/92",
        destructive:
        ...
        outline:
          "border-white/75 bg-white/75 text-foreground shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] [a&]:hover:bg-accent/60 [a&]:hover:text-accent-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
