...
/**
 * Chiave di accesso (menu, solo vista ridotta REG-429): path ESATTO del
 * prototipo — la chiave con il foro pieno, non la key di lucide.
 */
export const KeyProtoIcon = makeIcon(
  <>
...
/** Aspetto (cfgnav-aspetto): tavolozza da pittore con gocce di colore. */
export const PaletteProtoIcon = makeIcon(
  <>
