...
I nomi propri restano (sono le persone che faranno guidare i suoi allievi);
quello che sparisce è **chi c'è dentro** ogni slot occupato. È la lettura che
do a "slot occupati senza nomi".
...
**11. Fascia oraria fissa 07:00–21:00.**
La vista ridotta non ha il pannello "Visualizzazione" dell'agenda vera, quindi
non c'è dove configurarla.
