...
- → **Allievi del consorzio**: gli allievi creati dalla consorziata finiscono nella company del CONSORZIO con `consorzioSchoolId`. Chi cambia `CompanyMember`/`consorzioSchoolId` tocca anche questa strada, ed è la stessa da cui passeranno le richieste di guida (Fase 7).
