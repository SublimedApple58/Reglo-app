...
| Owner notifications (pagina Notifiche + annullamenti allievi) | [owner-notifications.md](features/owner-notifications.md) | `AutoscuolaNotification` model, `lib/autoscuole/notifications.ts`, `api/autoscuole/owner-notifications/route.ts`, `AutoscuoleNotifichePage.tsx`, `ComunicatoDialog.tsx`, `autoscuole.actions.ts` (`createStudentCancellationNotification`) |
