...
| Vista ridotta della consorziata senza Reglo (REG-429) | [consorzio.md](features/consorzio.md) | `components/pages/Autoscuole/locked/*`, `lib/actions/affiliate.actions.ts`, `lib/services.ts` (`isAffiliateWithoutReglo`), `components/ui/service-gate.tsx`, `AutoscuoleShell.tsx`, `public/images/locked/*` |
